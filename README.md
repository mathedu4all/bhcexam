...
* v1.1 is completely rewrited with article class with documentation [here](http://docs.mathcrowd.cn). [download](https://github.com/mathedu4all/bhcexam/releases/download/v1.1/bhcexam.zip).
